...
// * Connect to AMPS
// * Logon
// * Publish message to the "sample-queue" topic.
//
...
int main(void)
{
  ...
  AMPS::Client ampsClient("exampleQueuePublisher");
  ...
  try
  {
    ...
    for (int i = 0 ; i < 1000 ; ++i)
    {
      ...
      message << "{ \"message\"  \"Hello, World! This is message " << i
              << "\"}";


      // publish message
      ampsClient.publish("sample-queue", message.str());
    }
